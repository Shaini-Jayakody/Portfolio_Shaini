...
import faviconUrl from "../assets/logo-CUFrF9hI";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shaini Jayakody - Software Engineer Portfolio" },
      ...
      { property: "og:title", content: "Shaini Jayakody - Software Engineer Portfolio" },
