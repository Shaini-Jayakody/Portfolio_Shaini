...
import { U as User, F as FolderGit2, C as CodeXml, A as Award, B as Briefcase, M as Mail, S as Sun, a as Moon, X, b as Menu, R as Rocket, G as Github, L as Linkedin, c as ArrowDown, d as Compass, T as Target, e as GraduationCap, f as Users, g as Globe, E as ExternalLink, P as Palette, h as Smartphone, i as Monitor, j as Leaf, k as ChevronDown, l as ChevronRight, m as Figma, n as Play, o as Trophy, p as Medal, q as Star, r as PanelsTopLeft, s as Brain, D as Database, t as Search, u as Sparkles, v as Computer, w as BookOpen, x as Languages, y as School, z as CircleAlert, H as Check, I as Send, J as Shield, Z as Zap, K as Cloud, N as Network, O as Bot, Q as Package, V as Cpu, W as Code } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.header,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center justify-between rounded-2xl px-4 py-3 transition-all ${scrolled ? "bg-background border border-primary/20 shadow-lg" : "glass"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => go("hero"), className: "flex items-center gap-3 font-display text-base font-semibold", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient text-lg md:text-xl", children: "Shining Star" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center md:flex md:gap-2", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              onClick: () => go(l.id),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(l.icon, { className: `size-4 ${active === l.id ? "text-secondary" : "text-muted-foreground"}` }),
                l.label,
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "hero", className: "relative flex min-h-screen items-center overflow-hidden pt-28", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StarsBackground, { density: 0.5 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-cosmic", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/3 size-[600px] -translate-x-1/2 rounded-full bg-primary/10 blur-[120px]", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto grid w-full max-w-7xl gap-12 px-4 md:grid-cols-[1.2fr_1fr] md:items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex size-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-flex size-2 rounded-full bg-secondary" })
              ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.h1,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Shaini Jayakody" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/70 text-[40px]", children: "Undergraduate Software Engineer" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "size-4 transition-transform group-hover:-rotate-12" }),
                    "View Projects"
                  ]
                }
              ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/Shaini-Jayakody", target: "_blank", rel: "noreferrer", "aria-label": "GitHub", className: "transition-colors hover:text-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "size-5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.linkedin.com/in/shaini-jayakody-6a9197377", target: "_blank", rel: "noreferrer", "aria-label": "LinkedIn", className: "transition-colors hover:text-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "size-5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:shainijayakody8@gmail.com", "aria-label": "Email", className: "transition-colors hover:text-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-5" }) })
            ]
          }
        )
      ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 rounded-full ring-1 ring-inset ring-primary/30" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute -inset-6 -z-10 rounded-full bg-primary/20 blur-3xl" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.button,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "size-5" })
      }
    )
  ] });
}
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "about", eyebrow: "About Me", title: "A look into my universe", subtitle: "Software engineer and Designer at heart, curious about how things work.", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[1.1fr_1fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid gap-4 sm:grid-cols-2", children: cards.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-primary/15 bg-primary/5 p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "size-5 text-secondary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-base font-semibold", children: c.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 top-2 bottom-2 w-px bg-gradient-to-b from-primary/60 via-primary/20 to-transparent", "aria-hidden": true }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pb-4 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "size-4 text-secondary" }),
        " Education & journey"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-5", children: timeline.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.li,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-2 top-1.5 size-4 rounded-full border-2 border-background bg-primary glow-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex size-10 items-center justify-center rounded-xl bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(t.icon, { className: "size-5 text-secondary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-baseline justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold", children: t.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-secondary", children: t.year })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      href: t.url,
                      target: "_blank",
                      ...
                      children: [
                        t.place,
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "size-3 opacity-0 group-hover:opacity-100 transition-opacity" })
                      ]
                    }
                  ) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground/90 pl-13", children: t.desc })
            ] })
          ]
        },
        t.year
...
function Skills() {
  const [active, setActive] = reactExports.useState(CATS[0].id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "skills", eyebrow: "Skills", title: "My constellation of craft", subtitle: "A map of the technologies I navigate by.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-10 flex flex-wrap justify-center gap-2", children: CATS.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-4xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 800 500", className: "w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "centerGlow", cx: "50%", cy: "50%", r: "50%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.7 0.16 265 / 30%)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.7 0.16 265 / 0%)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "lineGrad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.7 0.16 265)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.85 0.11 230)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: center.x, cy: center.y, r: "140", fill: "url(#centerGlow)" }),
            ...
            nodes.map(
              (a, i) => nodes.slice(i + 1).map((b, j) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "line",
                {
                  x1: a.x,
                  y1: a.y,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: center.x, cy: center.y, r: "32", fill: "oklch(0.7 0.16 265 / 20%)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: center.x, cy: center.y, r: "48", fill: "oklch(0.7 0.16 265 / 10%)" })
          ] }),
          nodes.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "group",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 backdrop-blur-sm border transition-all duration-300 ${hoveredSkill === skill.name ? "border-primary shadow-lg shadow-primary/30 scale-110" : "border-primary/30 group-hover:border-primary/60 group-hover:scale-105"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-foreground", children: skill.name.charAt(0) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-full mt-2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-card/90 px-2.5 py-1 text-xs font-medium backdrop-blur-sm shadow-lg", children: skill.name }),
                hoveredSkill === skill.name && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    initial: { opacity: 0, y: 10 },
                    animate: { opacity: 1, y: 0 },
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl bg-card/95 px-4 py-2 backdrop-blur-md shadow-xl border border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Proficiency" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-bold text-primary", children: [
                          skill.level,
                          "%"
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-32 overflow-hidden rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.div,
                        {
                          initial: { width: 0 },
...
const TECH_STACK_CONFIG = {
  "MERN": { icon: CodeXml, color: "from-blue-500 to-cyan-500", label: "MERN Stack" },
  "Spring Boot": { icon: Leaf, color: "from-green-500 to-emerald-500", label: "Spring Boot" },
  "Other": { icon: CodeXml, color: "from-gray-500 to-gray-600", label: "Other Technologies" }
};
...
function Projects() {
  ...
  const [techFilter, setTechFilter] = reactExports.useState("All");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "projects", eyebrow: "Projects", title: "Where ideas become working systems", subtitle: "A few products and platforms I've helped bring to life.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex flex-wrap justify-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    showTechFilters && availableTechStacks.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-10 flex flex-wrap justify-center gap-2 border-t border-border/50 pt-6", children: availableTechStacks.map((tech) => {
      if (tech === "All") {
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { layout: true, className: "grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3", children: filteredItems.map((project, index) => {
      ...
      const TechIcon = techConfig?.icon || CodeXml;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.article,
        {
          layout: true,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative overflow-hidden ${isMobileOrUIUX ? "h-64 md:h-72 flex items-center justify-center bg-transparent" : "h-48 md:h-52 bg-gradient-to-br from-gray-900 to-gray-800"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: project.image,
              ...
              isWebProject && techConfig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute top-3 right-3 z-10 flex items-center gap-1.5 rounded-lg bg-gradient-to-r ${techConfig.color} bg-black/90 backdrop-blur-sm px-2.5 py-1.5 text-xs font-medium text-white shadow-lg`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TechIcon, { className: "size-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: techConfig.label })
              ] }),
              !isMobileOrUIUX && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" }),
              isMobileOrUIUX && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/10 via-transparent to-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 md:p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryIcon, { className: "size-4 text-secondary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold tracking-tight", children: project.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground line-clamp-2", children: project.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: expandedProject === project.title ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              expandedProject === project.title && /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.ul,
                {
                  ...
                  children: project.detailedDesc.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-xs text-muted-foreground flex items-start gap-2 leading-relaxed", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mt-0.5", children: "▹" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item })
                  ] }, idx))
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex flex-wrap gap-1.5", children: project.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-secondary/10 border border-secondary/20 px-2 py-0.5 text-[10px] font-medium text-secondary", children: tag.trim() }, tag)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex items-center gap-4 pt-3 border-t border-border/50", children: [
                project.github && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "size-3.5 transition-transform group-hover/btn:scale-110" }),
                      "Source Code"
                    ]
                  }
                ),
                project.figma && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: project.figma,
                    target: "_blank",
                    ...
                    className: "inline-flex items-center gap-1.5 text-xs text-muted-foreground transition-all hover:text-primary group/btn",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Figma, { className: "size-3.5 transition-transform group-hover/btn:scale-110" }),
                      "Figma Design"
                    ]
                  }
                ),
                project.liveSite && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "size-3 transition-transform group-hover/btn:scale-110" }),
                      "Live Site"
                    ]
                  }
                ),
                project.demo && !project.liveSite && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: project.demo,
                    target: "_blank",
                    ...
                    className: "inline-flex items-center gap-1.5 text-xs font-medium text-secondary transition-all hover:text-primary group/btn",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "size-3 transition-transform group-hover/btn:scale-110" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 rounded-2xl ring-1 ring-inset ring-transparent transition-all duration-300 group-hover:ring-primary/20" })
          ]
        },
        project.title
      );
    }) }),
    filteredItems.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16 text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-3", children: "🔍" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg", children: "No projects found with the selected filters" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Try adjusting the category or tech stack filters" })
    ] })
  ] });
}
const ROLES = [
...
function Journey() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "journey", eyebrow: "Journey", title: "A timeline through space", subtitle: "Stops along the way.", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-4xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-primary via-primary/30 to-transparent md:left-1/2", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-10", children: ROLES.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.li,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `pl-12 md:pl-0 ${i % 2 ? "md:pl-12" : "md:pr-12 md:text-right"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-2 top-1 size-4 rounded-full border-2 border-background bg-primary glow-primary md:left-1/2 md:-translate-x-1/2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-5 hover:shadow-lg transition-shadow duration-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 inline-flex items-center gap-2 text-xs text-secondary", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(r.icon, { className: `size-3.5 ${r.iconColor}` }),
              r.period
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold", children: r.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: r.society }),
            r.desc && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-gradient-to-r from-primary/50 to-transparent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/90 italic", children: r.desc })
            ] })
          ] })
        ] })
      },
...
function Achievements() {
  ...
  const [searchSkill, setSearchSkill] = reactExports.useState("");
  ...
  const getSkillIcon = (skill) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-2.5" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { id: "achievements", eyebrow: "Achievements", title: "Stars I've collected", subtitle: "Recognitions, certifications and milestones from my learning journey.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex flex-wrap justify-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Medal, { className: "size-4" }),
            " Badges"
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md", children: [
      ...
      searchSkill && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-xs text-muted-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: filteredItems.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute top-3 right-3 rounded-full px-2.5 py-1 text-[10px] font-medium backdrop-blur-sm flex items-center gap-1 ${it.type === "certification" ? "bg-blue-500/20 text-blue-400 border border-blue-500/30" : "bg-purple-500/20 text-purple-400 border border-purple-500/30"}`, children: [
            it.type === "certification" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "size-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Medal, { className: "size-3" }),
            it.type === "certification" ? "Certification" : "Badge"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-4 inline-flex", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-primary/20 blur-xl transition-all group-hover:bg-primary/40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative grid size-14 place-items-center rounded-full bg-gradient-to-br from-primary/30 to-secondary/30 ring-1 ring-primary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.icon, { className: "size-6 text-secondary" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base", children: it.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-secondary whitespace-nowrap bg-secondary/10 px-2 py-0.5 rounded-full", children: it.year })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-sm text-muted-foreground", children: it.issuer }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-1.5", children: it.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-medium text-secondary", children: [
            getSkillIcon(skill),
            skill
          ] }, skill)) }),
          it.credentialId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 pt-2 border-t border-border/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground/60 font-mono", children: [
            "ID: ",
            it.credentialId
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 rounded-2xl ring-1 ring-inset ring-transparent transition-all duration-300 group-hover:ring-primary/20" })
    ...
    filteredItems.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center size-16 rounded-full bg-primary/10 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "size-8 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground", children: "No achievements found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/70 mt-1", children: "Try a different search term or category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => {
...
const schema = objectType({
  name: stringType().trim().min(1, "Name is required").max(80),
  email: stringType().trim().email("Invalid email").max(160),
  message: stringType().trim().min(10, "Tell me a bit more (10+ chars)").max(1e3)
});
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "contact", eyebrow: "Contact", title: "Let's build beyond the horizon", subtitle: "Got a project, role or idea? My inbox is always open.", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[1fr_1.2fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold", children: "Find me across the universe" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Reach out anywhere below - I usually reply within a day." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-6 space-y-3 text-sm", children: [
        ...
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(l.icon, { className: "size-4 text-secondary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/90 group-hover:text-foreground", children: l.label })
          ]
        }
      ) }, l.label)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl bg-primary/5 p-4 border border-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Based in Sri Lanka | Available for remote work" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, className: "glass rounded-3xl p-8", noValidate: true, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "message", className: "text-xs uppercase tracking-wider text-muted-foreground", children: "Message" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            id: "message",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10 inline-flex items-center gap-2", children: status === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "size-4" }),
              " Sent — talk soon!"
            ] }) : status === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-4 animate-spin rounded-full border-2 border-white/30 border-t-white" }),
              "Sending..."
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "size-4 transition-transform group-hover:translate-x-0.5" }),
              " Send Message"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 -z-0 bg-gradient-to-r from-primary via-secondary to-primary bg-[length:200%_100%] opacity-0 transition-opacity group-hover:opacity-100 animate-shimmer" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-[10px] text-muted-foreground", children: "Your message will be sent directly to my email. I never share your information." })
    ] })
  ] }) });
}
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: id, className: "text-xs uppercase tracking-wider text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        id,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative border-t border-primary/10 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 sm:flex-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "size-4 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Shining Star · Exploring new worlds through code." })
    ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              ...
              children: [
                ...
                crossLinks.map(([a, b], i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.line,
                  {
                    x1: starPts[a][0],
                    y1: starPts[a][1],
                ...
                starPts.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.circle,
                  {
                    cx: p[0],
                    cy: p[1],
                ...
                ribbons.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.path,
                  {
                    d: r.d,
                    stroke: r.color,
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 -z-10 opacity-60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StarsBackground, { density: 0.8 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { theme, toggleTheme: () => setTheme((t) => t === "dark" ? "light" : "dark") }),
