...
const $$splitComponentImporter = () => import("./index-Cxz_xCHa.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of a software engineer crafting modern web, cloud and AI experiences. Explore projects, skills and achievements."
    }, {
      property: "og:title",
      content: "Shining Star — Software Engineer Portfolio"
    }, {
      property: "og:description",
      content: "Modern, cosmic-themed portfolio of a full-stack software engineer."
    }]
  }),
